...
Response Format
Implementation: List "Changes Made" (file + change), "Next Steps", "Notes" Troubleshooting: "Issue" → "Solution" → "Verification"

Critical Reminders
User controls servers, git, deployments
Document everything
Ask before paid resources
Mock before real integrations
